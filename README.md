...
| `INITIAL_CREDITS` / `CREDITS_PER_SECOND` | Початкові баланс і ставка **для нової бази**, типово `300` / `2.85`                                      |
